...
vi.mock("@/stores/uiStore", () => ({
  setCurrentTab: vi.fn(), currentTab: () => "me", layoutMode: () => "waterfall",
  useDnsOverride: () => false, showSettingsDrawer: () => false,
  closeSettingsDrawer: vi.fn(), theme: () => "system",
  ageConfirmed: () => true, isAdult: () => true,
  openSettingsDrawer: vi.fn(),
  listQuality: () => "medium", setListQuality: vi.fn(),
  detailQuality: () => "large", setDetailQuality: vi.fn(),
  showR18: () => true, setShowR18: vi.fn(),
  showR18G: () => true, setShowR18G: vi.fn(),
  hasUpdate: () => false, isCheckingUpdate: () => false,
  latestVersion: () => "", checkCompleted: () => false,
  autoCheckUpdate: () => false, setAutoCheckUpdate: vi.fn(),
  setHasUpdate: vi.fn(), setIsCheckingUpdate: vi.fn(),
  setLatestReleaseUrl: vi.fn(), setLatestVersion: vi.fn(),
  setCheckCompleted: vi.fn(), resetUiStore: vi.fn(),
